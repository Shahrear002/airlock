...
- **📂 SFTP File Transfer**: Integrated dual-pane file manager for seamless drag-and-drop transfers between local and remote systems.
- **📝 Edit Locally**: Right-click any remote file to open it in your system's default editor. Airlock watches for saves and auto-uploads changes back to the server in real-time.
